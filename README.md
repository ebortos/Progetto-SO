...
- git add *nome file* (si puo usare anche "git add ." per aggiungere tutta la repository locale, attenzione solo a non aggiungere robe a caso)
...
- Andare relativamente in ordine per quanto possibile
- TESTARE IL PEZZO DI CODICE SUBITO CON UNA SUITE DEDICATA (non importa se codice sritto a mano, con unity, gpt o con il cane, basta che venga testato per i casi base perlomeno)
- Dovessero essere riscontrate delle difficoltà in un determinato pezzo di codice, scrivere un abbozzo (*funzionante*) per poter andare avanti ed eventualmente revisionarlo successivamente
- 
- 
- 
- 
- Non fumare troppo (facoltativo)
<br>
<br>
<br>
<br>
...
<br>
<br>
Se leggi fino a qui sei gay (coglione)
